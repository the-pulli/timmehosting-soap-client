...
try {
    ...
    $folder_user_record = $client->sites_web_folder_user_get($session_id, $folder_user_id);

    // * Change parameters
    $folder_user_record['active'] = 'n';

    $affected_rows = $client->sites_web_folder_user_update($session_id, $client_id, $folder_user_id, $folder_user_record);
